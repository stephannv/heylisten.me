...
RSpec.describe ImportNintendoJapanData, type: :mutations do
  ...
  describe 'Private instance methods' do
    describe '#fetch_data' do
      ...
      before do
        allow(FetchNintendoJapanData).to receive(:run!).and_return(data_collection)
      end
  ...
  describe '#parse_data' do
    ...
    before do
      ...
      allow(NintendoJapanDataAdapter).to receive(:new)
        .with(data: data_item)
        .and_return(adapter)
    end
